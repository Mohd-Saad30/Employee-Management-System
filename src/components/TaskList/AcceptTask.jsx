...
function AcceptTask({task}) {
    ...
    <div className="flex flex-col shrink-0 h-[220px] w-[340px] bg-white/95 rounded-3xl p-7 border border-blue-100 ">
            ...
            <div className="flex justify-between mt-2 ">
                    <button className="bg-green-400 hover:bg-green-600 text-white font-semibold  rounded-lg p-1 ">
                        Mark as Completed
                    </button>
                    <button className="bg-red-400 hover:bg-red-600 text-white font-semibold  rounded-lg p-1">
                        Mark as Failed
                    </button>
            </div>
        </div>
